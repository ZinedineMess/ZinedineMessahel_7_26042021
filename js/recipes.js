...
export default class Recipes {
    displayRecipes(data) {
        data.forEach(recipe => {
            ...
            articleRecipe.classList.add('article-recipes');
            articleRecipe.setAttribute('data-filter', recipe.ingredients.map(element => element.ingredient) + recipe.ustensils + recipe.appliance);
        })
    }
}